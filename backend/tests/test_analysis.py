...
def _sample_analysis() -> PaperAnalysis:
    return PaperAnalysis(
        ...
        solvent_ratio="EC:DMC = 1:1 v/v",
        loading="2.5 mg/cm2",
        np_ratio="1.1",
        electrolyte_amount="50 uL",
        initial_capacity="180 mAh/g",
        capacity_retention="92% after 200 cycles",
        cycle_life="200 cycles",
        coulombic_efficiency="99.5%",
        rate_performance="85% capacity retention at 5C",
        main_performance_claim="Stable long-term cycling with FEC/VC co-additives",
        main_findings=["Improved cycling stability with FEC additive"],
        innovation="Novel FEC/VC co-additive combination",
        main_contribution="Demonstrates a co-additive strategy that extends cycle life",
