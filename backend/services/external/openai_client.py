...
_ANALYSIS_RESPONSE_SCHEMA = {
    ...
    "properties": {
        ...
        "solvent_ratio": {"type": ["string", "null"]},
        "loading": {"type": ["string", "null"]},
        "np_ratio": {"type": ["string", "null"]},
        "electrolyte_amount": {"type": ["string", "null"]},
        "initial_capacity": {"type": ["string", "null"]},
        "capacity_retention": {"type": ["string", "null"]},
        "cycle_life": {"type": ["string", "null"]},
        "coulombic_efficiency": {"type": ["string", "null"]},
        "rate_performance": {"type": ["string", "null"]},
        "main_performance_claim": {"type": ["string", "null"]},
        "main_findings": {"type": "array", "items": {"type": "string"}},
        "innovation": {"type": ["string", "null"]},
        "main_contribution": {"type": ["string", "null"]},
